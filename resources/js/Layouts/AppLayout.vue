            ...
            <div class="sticky top-0 z-40 flex h-14 shrink-0 items-center gap-x-4 border-b border-white/20 bg-primary-900 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                    <form class="relative flex flex-1" action="#" method="GET">
                        ...
                        <input id="search-field" class="bg-transparent block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Search..." type="search" name="search">
                    </form>
                            ...
                            <template #trigger>
                                <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <span class="ml-4 text-sm font-semibold leading-6" aria-hidden="true">{{ $page.props.auth.user.name }}</span>
                                        <PhCaretDown weight="bold" class="ml-2 size-4.5 text-gray-400"/>
                                    </span>
                                </button>
                            </template>
